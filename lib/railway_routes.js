...
['get', 'post', 'put', 'delete', 'del', 'all'].forEach(function (method) {
    Map.prototype[method] = function (subpath, arg1, arg2, options) {

        var controller, action, middleware, handler;
	
	if (typeof arg1 == 'function' || arg1 instanceof Array) {
	    // A middleware has been passed
	    middleware = arg1;
	    handler = arg2;
	}
	else {
